...
//******************************************************************************
uint32_t WS_TaskIfg = 0;                                         //就绪标志位
uint8_t WS_TaskState = 0;                                           //当前任务
const uint32_t WS_TaskMap[32] =                                  //标志位操作表
{
    0x00000001 , 0x00000002 , 0x00000004 , 0x00000008 , 0x00000010 , 0x00000020 , 0x00000040 , 0x00000080,
    0x00000100 , 0x00000200 , 0x00000400 , 0x00000800 , 0x00001000 , 0x00002000 , 0x00004000 , 0x00008000,
    0x00010000 , 0x00020000 , 0x00040000 , 0x00080000 , 0x00100000 , 0x00200000 , 0x00400000 , 0x00800000,
    0x01000000 , 0x02000000 , 0x04000000 , 0x08000000 , 0x10000000 , 0x20000000 , 0x40000000 , 0x80000000u
};
#endif
...
{
	uint8_t res=0;
	if(((WS_TaskMap[AllPrio])&WS_TaskIfg)!=(uint32_t)0)
	{
		res=1;
	}
	else
